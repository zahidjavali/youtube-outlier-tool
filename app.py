...
<style>
    ...
    .video-title a { font-size: 1.1rem; font-weight: 600; margin-bottom: 8px; color: #FFFFFF; }
...
def analyze_videos(youtube_service, search_type, query_input, view_multiplier, min_views, avg_multiplier):
    try:
        ...
        if "avg" in search_type:
            ...
            df['outlier_score'] = df['views'] / np.maximum(1, avg_source)
    ...
    with st.spinner("🔄 Analyzing videos..."):
        ...
        if err: st.error(err)
            ...
            if not outliers_df.empty:
                ...
                v2.info("No outliers found to visualize.")
